package com.example.video_meeting_app.Firebase;
...
import com.example.video_meeting_app.Activities.IncomingInvitationActivity;
...
//        Log.d("FCM" , Objects.requireNonNull(message.getNotification()).getBody() + "");
